...
$articlePath = '/blog/making-natural-capital-visible-in-everyday-transactions/';

$metaDescriptionEn = 'Why sustainability must become visible in everyday transactions, not only in central bank mandates and institutional finance.';
$metaDescriptionFr = 'Pourquoi la durabilité doit devenir visible dans les transactions quotidiennes, et pas seulement dans les mandats institutionnels.';
$metaDescriptionDe = 'Warum Nachhaltigkeit nicht nur in Zentralbankmandaten, sondern in alltäglichen Entscheidungen wirtschaftlich sichtbar werden muss.';

if ($locale === 'fr') {
  $pageTitle = 'Des mandats de banque centrale aux transactions quotidiennes';
  $metaTitle = 'Capital naturel dans les transactions quotidiennes';
} elseif ($locale === 'de') {
  $pageTitle = 'Von Zentralbankmandaten zu alltäglichen Transaktionen';
  $metaTitle = 'Naturkapital im Alltag sichtbar machen | My Drop In The Oceans';
} else {
  $pageTitle = 'From Central Bank Mandates to Everyday Transactions';
  $metaTitle = 'Natural Capital in Everyday Transactions';
}

$metaKeywordsEn = 'SwissPowerShift, Jean-Pierre Danthine, Swiss National Bank, SNB, BNS, sustainability, natural capital, Nature, economy, everyday transactions, Citizen\'s Dividend for Nature, sustainable finance, My Drop In The Oceans';
$metaKeywordsFr = 'SwissPowerShift, Jean-Pierre Danthine, Banque nationale suisse, BNS, durabilité, capital naturel, Nature, économie, transactions quotidiennes, dividende citoyen pour la Nature, finance durable, My Drop In The Oceans';
$metaKeywordsDe = 'SwissPowerShift, Jean-Pierre Danthine, Schweizerische Nationalbank, SNB, BNS, Nachhaltigkeit, Naturkapital, Natur, Wirtschaft, alltägliche Transaktionen, Bürgerdividende für die Natur, nachhaltige Finanzwirtschaft, My Drop In The Oceans';

if ($locale === 'fr') {
  $metaKeywords = $metaKeywordsFr;
  $metaDescription = $metaDescriptionFr;
} elseif ($locale === 'de') {
  $metaKeywords = $metaKeywordsDe;
...
<head>
    ...
    <script type="application/ld+json">
    {
      ...
      "alternativeHeadline": "<?php echo htmlspecialchars($metaTitle, ENT_QUOTES); ?>",
      ...
      "isBasedOn": "https://swisspowershift.ch/integrer-la-question-de-durabilite-au-mandat-de-la-bns-lidee-nest-pas-mauvaise/"
    }
    </script>
    ...
    <div style="border: 0;margin: 0;">
      <div id="landing_page" >
        ...
        <div class="intro_box"><br>
          <b>Blog</b><br><?php echo htmlspecialchars($pageTitle); ?>
        </div>

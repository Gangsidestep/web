<div id="landing_page"> 
	...
	<div class="white_page_span" id="bottom_page_span">
		...
		<span class="span_text_box">
			Diese Theorie des Wandels beschreibt die Entwicklung von <i>my drop in the oceans</i> von einer grundlegenden Vision hin zu einem Rahmen,
			der durch reale Initiativen wie <a href="https://mydio.com/" class="link" target="_blank" rel="noopener noreferrer">mydio.com</a> praktisch erprobt wird.
		...
		<span class="span_text_box">
			...
			<a href="<?php echo htmlspecialchars(localized_path('/blog/make-money-first-then-think-of-nature/', $locale)); ?>" class="link">Make Money First, Then (Maybe) Think of Nature</a>.
		</span>
		...
		<h2 class="header_two">Naturkapital als grundlegenden Wohlstand anerkennen</h2>
		<span class="span_text_box">
			Wenn Wert neu gestaltet werden soll, muss zuerst geklärt werden, was letztlich bewertet wird — und für wen.<br><br>
			...
			Die Anerkennung und der Schutz von Naturkapital sind jedoch zentral für eine resiliente Zukunft.<br><br>

			Naturkapital bezeichnet die natürlichen Systeme — Böden, Wälder, Wasser, Biodiversität und klimatische Stabilität —, die die Grundlage unserer Wirtschaft und unseres Wohlstands bilden.<br><br>

			Natur ist kein externer Input der Wirtschaft. Sie ist ihre Voraussetzung.
			Jede Form von Wohlstand, öffentlich oder privat, hängt von ökologischer Stabilität, Biodiversität, Wasserkreisläufen und Klimasystemen ab, die in keiner Bilanz vollständig erfasst sind.<br><br>
		...
		<span class="span_text_box">
			...
			Das Ziel ist nicht, künstlich neue Werte zu erzeugen, sondern den realen wirtschaftlichen Wert gesunder natürlicher Systeme sichtbar und wirtschaftlich lesbar zu machen.<br><br>
			...
			Anspruch auf Teilhabe an regenerativen Systemen und Verpflichtung, zu deren Fortbestand beizutragen.<br><br>
			...
			während wissenschaftliche und öffentliche Institutionen mitbestimmen, wie ökologische Werte gemessen, validiert und über die Zeit in robuste Rahmen übersetzt werden.<br><br>
		...
		<h2 class="header_two">Die Theorie des Wandels in die Praxis bringen</h2>
		<span class="span_text_box">
			Diese Anerkennung in die Praxis zu übersetzen, erfordert Mechanismen, die in der Alltagswirtschaft wirken.<br><br>
			...
			Haushalte, Unternehmen und Gemeinschaften begegnen Wertsignalen täglich — durch Preise, Anreize und die Verteilung von Nutzen.<br><br>

			Entscheidend ist, dass diese Wertsignale im Alltag wirken — bei Mobilität, Konsum und finanziellen Entscheidungen.<br><br>
			...
			Je näher ökologische Bilanzierung an reale Ausgeglichenheit kommt, desto weniger dynamisch muss eine solche Preissteuerung sein.<br><br>

			In diesem Sinn ersetzt Umsetzung die Theorie nicht. Sie setzt sie realen Bedingungen aus —
			und ermöglicht Verfeinerung, Rechenschaft und kontinuierliches Lernen.<br><br>
		...
		<span class="span_text_box">
			...
			sondern eine Anreizinfrastruktur schaffen, die mit Fortschritt von Wissenschaft und öffentlichen Institutionen schrittweise bessere Messgrössen integrieren kann.<br><br>
		...
		<h2 class="header_two">Richtung der Entwicklung: eine regenerative Wirtschaft aufbauen</h2>
		<span class="span_text_box">
			Systemischer Wandel entsteht nicht durch Erklärungen allein.
			Er entfaltet sich durch die schrittweise Neuausrichtung von Anreizen, Institutionen und alltäglicher Teilnahme.<br><br>
			...
			und dass dauerhafte Prosperität von ihrer Regeneration in einer tatsächlich regenerativen Wirtschaft abhängt.<br><br>
		...
		<div class="social-share-bar">
			...
			<a href="https://www.linkedin.com/shareArticle?mini=true&url=https://mydropintheoceans.org/de/theory-of-change/" target="_blank" rel="noopener noreferrer" class="social-link"><img src="/images/social/linkedin.svg" alt="LinkedIn" style="width:28px;height:28px;vertical-align:middle;"></a>
			<a href="https://twitter.com/intent/tweet?url=https://mydropintheoceans.org/de/theory-of-change/&text=Theorie%20des%20Wandels%3A%20Wirtschaft%20und%20Natur%20im%20Einklang" target="_blank" rel="noopener noreferrer" class="social-link"><img src="/images/social/twitter.svg" alt="Twitter" style="width:28px;height:28px;vertical-align:middle;"></a>
			<a href="https://www.facebook.com/sharer/sharer.php?u=https://mydropintheoceans.org/de/theory-of-change/" target="_blank" rel="noopener noreferrer" class="social-link"><img src="/images/social/facebook.svg" alt="Facebook" style="width:28px;height:28px;vertical-align:middle;"></a>
			<a href="https://wa.me/?text=Theorie%20des%20Wandels%3A%20Wirtschaft%20und%20Natur%20im%20Einklang%20https://mydropintheoceans.org/de/theory-of-change/" target="_blank" rel="noopener noreferrer" class="social-link"><img src="/images/social/whatsapp.svg" alt="WhatsApp" style="width:28px;height:28px;vertical-align:middle;"></a>
		</div>

		<div class="related-links" style="margin: 1.25em 0; padding: 1em; background: #f6f6f6; border-radius: 4px;">
			<strong>Verwandte Seiten</strong>
			<ul style="font-size: 0.82em;list-style:none;padding:0;margin:0.5em 0 0 0;display:flex;flex-wrap:wrap;gap:0.75em;">
				<li><a class="link" href="<?php echo htmlspecialchars(localized_path('/', $locale)); ?>">Startseite</a></li>|
				<li><a class="link" href="<?php echo htmlspecialchars(localized_path('/blog/', $locale)); ?>">Zum Blog</a></li>|
				<li><a class="link" href="<?php echo htmlspecialchars(localized_path('/blog/make-money-first-then-think-of-nature/', $locale)); ?>">Make Money First, Then (Maybe) Think of Nature — Essay</a></li>|
				<li><a class="link" href="<?php echo htmlspecialchars(localized_path('/blog/nature-is-not-a-charity/', $locale)); ?>">Warum Natur kein Wohltätigkeitsprojekt ist — Essay</a></li>|
	...
	<div class="white_page_span" style="margin-top: 40px;">
		...
		<div class="faq-item" style="margin-top: 18px;">
			<h3 class="header_three">Wie könnte eine Bürgerdividende für die Natur legitimiert werden?</h3>
			<span>Ihre langfristige Legitimität hängt von demokratischer Zustimmung durch Bürgerinnen und Bürger ab, ergänzt durch wissenschaftliche und öffentliche Institutionen, die messen, validieren und weiterentwickeln, wie ökologische Werte über die Zeit anerkannt werden.</span>
		</div>
	</div>
</div>
...
ath.intl = {
	...
	en_us: {
		ios: 'To add the MyDIO web app to your home screen: tap %icon and then <strong>Add to Home Screen</strong>.',
		android: 'To add the MyDIO web app to your home screen open the browser option menu and tap on <strong>Add to homescreen</strong>. <small>The menu can be accessed by pressing the menu hardware button if your device has one, or by tapping the top right menu icon %icon.</small>'
	},

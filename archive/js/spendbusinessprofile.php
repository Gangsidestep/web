				 ...
				 $.ajax({
                    ...
                    success:function(data){
                       ...
                       var pos = new google.maps.LatLng(this.lat, this.lng);
							...
							if(company=='<?php echo $companyname; ?>')
                                {
                                    map.setCenter(pos); 
...
if($logged)
   ...
   ?>
            ...
            <ul id="user-actions" class="pull-right dropdown-menu">
							<li><a href="/login/index.php?redirect=<?php echo urlencode($server); ?>">Login</a></li>
  ...
  <div class="bdropbottom">
   <div class="fade_in">
   <div id="rew_msg" class="infobox" style="display:<? echo $show_message; ?>">
			  <div class="postcode">
			<div style="width:20px; position:absolute; height:20px; top:5; text-align:right; left:227px;"><a class="close_prompt"><button type="button" name="fade" class="btn btn-flat btn-primary btn-large">X</button></a></div><h6>&nbsp;</h6>
			<p align="center" id="msg_img" > </p>
			<h6>&nbsp;</h6>
			<h3>Congratulations!</h3>
			<h4 id="msg_txt">With an average rate of 45% of household waste being recycled in Geneva you have earned 450 DIO rewards (worth 45 CHF)</h4>
			<h6>&nbsp;</h6>
			</div> </div>

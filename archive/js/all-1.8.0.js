...
buf.push("</ol></li>");;return buf.join("");
}
,
...
{
buf.push(null == (jade.interp = t('notif_friend_from_fb', { defaultValue: 'A friend from Facebook has recently joined Bloglovin', escapeInterpolation: true, userLink: userLink })) ? "" : jade.interp);
}
else if ( type == 'intro:welcome')
{
buf.push(null == (jade.interp = t('notif_intro_welcome', { defaultValue: 'Welcome to Bloglovin!', escapeInterpolation: true, userLink: userLink })) ? "" : jade.interp);
}
...
buf.push("<div class=\"timestamp\">" + (jade.escape((jade.interp = cluster.date) == null ? '' : jade.interp)) + "</div></li>");;return buf.join("");
}
,
"signup/errors/email":function anonymous(locals) {
var buf = [];
var locals_ = (locals || {}),errors = locals_.errors,t = locals_.t;if ( errors)
{
buf.push(jade.escape(null == (jade.interp = t('signup_error_email', { defaultValue: 'Email invalid.', context: errors.email } )) ? "" : jade.interp));
}
else
{
buf.push(jade.escape(null == (jade.interp = t('signup_error_email', { defaultValue: 'Email invalid.' } )) ? "" : jade.interp));
};return buf.join("");
}
,
...
var buf = [];
var locals_ = (locals || {}),post = locals_.post,count = locals_.count,default_avatar = locals_.default_avatar,avatar = locals_.avatar,baseUrl = locals_.baseUrl,t = locals_.t,contextType = locals_.contextType,url = locals_.url;if ( (post.event_type === 'follow_user' || post.event_type === 'follow_blog'))
{
...
buf.push("<a" + (jade.attrs({ 'href':("/blog/" + (post.blog.id) + ""), 'rel':("author"), "class": [('author')] }, {"href":true,"rel":true})) + ">" + (null == (jade.interp = post.blog.name) ? "" : jade.interp) + "</a><a" + (jade.attrs({ 'href':("" + (post.link) + "") }, {"href":true})) + "><time" + (jade.attrs({ 'datetime':(post.publish_timestamp) }, {"datetime":true})) + ">" + (jade.escape(null == (jade.interp = post.publish_date) ? "" : jade.interp)) + "</time></a><a" + (jade.attrs({ 'href':("" + (post.out_link) + ""), 'rel':("nofollow"), 'target':("_blank"), "class": [('post-link'),(readable ? 'readable' : '')] }, {"class":true,"href":true,"rel":true,"target":true})) + "><h2 class=\"title\">" + (null == (jade.interp = post.title) ? "" : jade.interp) + "</h2><p class=\"body\">" + (null == (jade.interp = post.summary) ? "" : jade.interp) + "</p></a><ul class=\"meta horizontal-list\"><li><a" + (jade.attrs({ 'href':("/_/post/like/" + (post.blog.id) + "/" + (post.id) + ""), 'data-tooltip':("tooltip"), 'data-title':(t('like', { defaultValue: 'Like' })), "class": [('like')] }, {"href":true,"data-tooltip":true,"data-title":true})) + "><div class=\"tiled-post-heart-icon\"></div></a><a" + (jade.attrs({ 'href':("/_/post/unlike/" + (post.blog.id) + "/" + (post.id) + ""), 'data-tooltip':("tooltip"), 'data-title':(t('unlike', { defaultValue: 'Unlike' })), "class": [('unlike')] }, {"href":true,"data-tooltip":true,"data-title":true})) + "><div class=\"tiled-post-heart-icon\"></div></a><a" + (jade.attrs({ 'href':("/blog/post/" + (post.blog.id) + "/" + (post.id) + "/saves"), "class": [('total-likes')] }, {"href":true})) + ">");
if ( post.likes)
{
...
buf.push("<li><a" + (jade.attrs({ 'href':("#shareModal-" + (post.blog.id) + "-" + (post.id) + ""), 'data-tooltip':("tooltip"), 'data-title':(t('share', { defaultValue: 'Share' })), 'data-trigger':("modal"), "class": [('share')] }, {"href":true,"data-tooltip":true,"data-title":true,"data-trigger":true})) + "><div class=\"tiled-post-share-icon\"></div></a></li></ul></div></article></div><ul" + (jade.attrs({ 'data-post-id':("" + (post.id) + ""), "class": [('share-dialog')] }, {"data-post-id":true})) + "><li><a" + (jade.attrs({ 'href':("" + (post.post_link) + ""), 'rel':("nofollow"), 'data-func':("facebookPost"), 'data-desc':(post.summary ? "" + (post.summary) + "" : null), 'data-name':("" + (post.title) + ""), 'data-caption':("" + (post.source) + ""), 'data-pic':(post.media ? "" + (post.media) + "" : null), "class": [('facebook')] }, {"href":true,"rel":true,"data-func":true,"data-desc":true,"data-name":true,"data-caption":true,"data-pic":true})) + "><div class=\"facebook-button-icon\"></div><span>" + (jade.escape(null == (jade.interp = t('share_dialog_facebook', { defaultValue: 'Post to facebook' })) ? "" : jade.interp)) + "</span></a></li><li><a" + (jade.attrs({ 'href':("https://twitter.com/share?url=" + (encodeURIComponent(post.post_link)) + "&via=bloglovin&text=" + (post.title) + ""), 'rel':("nofollow"), 'data-func':("tweet"), 'data-title':(t('twitter_popup_title', { defaultValue: 'Tweet this!' })), 'target':("_blank"), "class": [('twitter')] }, {"href":true,"rel":true,"data-func":true,"data-title":true,"target":true})) + "><div class=\"twitter-button-icon\"></div><span>" + (jade.escape(null == (jade.interp = t('share_dialog_twitter', { defaultValue: 'Tweet this' })) ? "" : jade.interp)) + "</span></a></li></ul><div" + (jade.attrs({ 'id':("shareModal-" + (post.blog.id) + "-" + (post.id) + ""), "class": [('modal'),('share-modal')] }, {"id":true})) + "><div class=\"modal-header\"><a href=\"#\" class=\"close\">&times;</a><div class=\"modal-label\">" + (jade.escape(null == (jade.interp = t('share_modal_label', { defaultValue: 'Share post'})) ? "" : jade.interp)) + "</div></div><div class=\"modal-body\"><ul><li><a" + (jade.attrs({ 'href':("mailto:?body=" + (encodeURIComponent(post.title)) + " from the blog " + (encodeURIComponent(post.blog.name)) + " %0A" + (encodeURIComponent(post.post_link)) + " %0A%0ASign up for Bloglovin:%0Ahttp://www.bloglovin.com/signup&subject=Link from Bloglovin"), 'data-func':("emailPost"), 'data-post-id':("" + (post.id) + ""), 'target':("_blank") }, {"href":true,"data-func":true,"data-post-id":true,"target":true})) + "><div class=\"email-icon\"></div><span>" + (jade.escape(null == (jade.interp = t('email', { defaultValue: 'Email' })) ? "" : jade.interp)) + "</span></a></li><li><a" + (jade.attrs({ 'href':("" + (post.post_link) + ""), 'rel':("nofollow"), 'data-func':("facebookPost"), 'data-desc':(post.summary ? "" + (post.summary) + "" : null), 'data-name':("" + (post.title) + ""), 'data-caption':("" + (post.source) + ""), 'data-pic':(post.media ? "" + (post.media) + "" : null), 'data-post-id':("" + (post.id) + "") }, {"href":true,"rel":true,"data-func":true,"data-desc":true,"data-name":true,"data-caption":true,"data-pic":true,"data-post-id":true})) + "><div class=\"facebook-icon\"></div><span>" + (jade.escape(null == (jade.interp = t('facebook', { defaultValue: 'Facebook' })) ? "" : jade.interp)) + "</span></a></li><li><a" + (jade.attrs({ 'href':("https://twitter.com/share?url=" + (encodeURIComponent(post.post_link)) + "&via=bloglovin&text=" + (encodeURIComponent(post.title)) + ""), 'rel':("nofollow"), 'data-func':("tweet"), 'data-post-id':("" + (post.id) + ""), 'data-title':(t('twitter_popup_title', { defaultValue: 'Tweet this!' })), 'target':("_blank") }, {"href":true,"rel":true,"data-func":true,"data-post-id":true,"data-title":true,"target":true})) + "><div class=\"twitter-icon\"></div><span>" + (jade.escape(null == (jade.interp = t('twitter', { defaultValue: 'Twitter' })) ? "" : jade.interp)) + "</span></a></li><li class=\"last-child\"><a" + (jade.attrs({ 'href':("" + (post.post_link) + ""), 'rel':("nofollow"), 'data-func':("pin"), 'data-name':("" + (post.title) + ""), 'data-pic':(post.media ? "" + (post.media) + "" : null), 'data-post-id':("" + (post.id) + "") }, {"href":true,"rel":true,"data-func":true,"data-name":true,"data-pic":true,"data-post-id":true})) + "><div class=\"pinterest-icon\"></div><span>" + (jade.escape(null == (jade.interp = t('pinterest', { defaultValue: 'Pinterest' })) ? "" : jade.interp)) + "</span></a></li></ul></div></div></li>");
};return buf.join("");
}
,
...
var feedLinkEnd = '</a>';
buf.push(null == (jade.interp = t('gritter_user_followed', { defaultValue: 'was added to __feedLinkHTML__ your Friends feed. __feedLinkEndHTML__', escapeInterpolation: true, feedLink: feedLink, feedLinkEnd: feedLinkEnd })) ? "" : jade.interp);;return buf.join("");
}
,
"feed/toolbar_group":function anonymous(locals) {
var buf = [];
var locals_ = (locals || {}),group = locals_.group,t = locals_.t;buf.push("<li><a" + (jade.attrs({ 'href':("#"), 'data-group-id':("" + (group.group_id) + ""), 'data-trigger':("change-group") }, {"href":true,"data-group-id":true,"data-trigger":true})) + ">" + (null == (jade.interp = [ group.group_id == 1 ? t('toolbar_unsorted_blogs', { defaultValue: 'Unsorted blogs' }) : group.group_name ]) ? "" : jade.interp) + "</a></li>");;return buf.join("");
}
,
"feed/unfollow_alert":function anonymous(locals) {
var buf = [];
var locals_ = (locals || {}),t = locals_.t;buf.push("<li class=\"alert unfollow-alert a-hide\">" + (jade.escape(null == (jade.interp = t('toolbar_unfollow_alert', { defaultValue: 'You are no longer following'})) ? "" : jade.interp)) + (jade.escape(null == (jade.interp = " ") ? "" : jade.interp)) + "<span class=\"unfollow-blog-name\"></span>" + (jade.escape(null == (jade.interp = ". ") ? "" : jade.interp)) + "<a href=\"#\" class=\"undo-unfollow\">" + (jade.escape(null == (jade.interp = t('toolbar_unfollow_alert_undo', { defaultValue: 'Undo?'})) ? "" : jade.interp)) + "</a></li>");;return buf.join("");
}
,
...
buf.push("<a" + (jade.attrs({ 'href':("" + (post.out_link) + ""), 'rel':("nofollow"), 'target':("_blank"), "class": [('post-link'),(readable ? 'readable' : '')] }, {"class":true,"href":true,"rel":true,"target":true})) + ">");
if ( post.media)
{
...
buf.push("<h2 class=\"title\">" + (null == (jade.interp = post.title) ? "" : jade.interp) + "</h2></a><div class=\"subtitle\"><address class=\"author\"><a" + (jade.attrs({ 'href':("" + (baseUrl) + "/blog/" + (post.blog.id) + ""), 'rel':("author") }, {"href":true,"rel":true})) + ">" + (null == (jade.interp = post.blog.name) ? "" : jade.interp) + "</a></address>&nbsp;&middot;&nbsp;<div class=\"date\"><a" + (jade.attrs({ 'href':("" + (post.post_link) + "") }, {"href":true})) + "><time" + (jade.attrs({ 'datetime':(post.publish_timestamp) }, {"datetime":true})) + ">" + (jade.escape(null == (jade.interp = post.publish_date) ? "" : jade.interp)) + "</time></a></div></div><a" + (jade.attrs({ 'href':("" + (post.out_link) + ""), 'rel':("nofollow"), 'target':("_blank"), "class": [('post-link'),(readable ? 'readable' : '')] }, {"class":true,"href":true,"rel":true,"target":true})) + "><p class=\"body\">" + (null == (jade.interp = post.summary) ? "" : jade.interp) + "</p></a><ul class=\"meta horizontal-list\">");
if ( (readable))
{
...
buf.push("</li></ul></article></div><ul" + (jade.attrs({ 'data-post-id':("" + (post.id) + ""), "class": [('share-dialog')] }, {"data-post-id":true})) + "><li><a" + (jade.attrs({ 'href':("" + (post.post_link) + ""), 'rel':("nofollow"), 'data-func':("facebookPost"), 'data-desc':(post.summary ? "" + (post.summary) + "" : null), 'data-name':("" + (post.title) + ""), 'data-caption':("" + (post.source) + ""), 'data-pic':(post.media ? "" + (post.media) + "" : null), "class": [('facebook')] }, {"href":true,"rel":true,"data-func":true,"data-desc":true,"data-name":true,"data-caption":true,"data-pic":true})) + "><div class=\"facebook-button-icon\"></div><span>" + (jade.escape(null == (jade.interp = t('share_dialog_facebook', { defaultValue: 'Post to facebook' })) ? "" : jade.interp)) + "</span></a></li><li><a" + (jade.attrs({ 'href':("https://twitter.com/share?url=" + (encodeURIComponent(post.post_link)) + "&via=bloglovin&text=" + (post.title) + ""), 'rel':("nofollow"), 'data-func':("tweet"), 'data-title':(t('twitter_popup_title', { defaultValue: 'Tweet this!' })), 'target':("_blank"), "class": [('twitter')] }, {"href":true,"rel":true,"data-func":true,"data-title":true,"target":true})) + "><div class=\"twitter-button-icon\"></div><span>" + (jade.escape(null == (jade.interp = t('share_dialog_twitter', { defaultValue: 'Tweet this' })) ? "" : jade.interp)) + "</span></a></li></ul><div" + (jade.attrs({ 'id':("shareModal-" + (post.blog.id) + "-" + (post.id) + ""), "class": [('modal'),('share-modal')] }, {"id":true})) + "><div class=\"modal-header\"><a href=\"#\" class=\"close\">&times;</a><div class=\"modal-label\">" + (jade.escape(null == (jade.interp = t('share_modal_label', { defaultValue: 'Share post'})) ? "" : jade.interp)) + "</div></div><div class=\"modal-body\"><ul><li><a" + (jade.attrs({ 'href':("mailto:?body=" + (encodeURIComponent(post.title)) + " from the blog " + (encodeURIComponent(post.blog.name)) + " %0A" + (encodeURIComponent(post.post_link)) + " %0A%0ASign up for Bloglovin:%0Ahttp://www.bloglovin.com/signup&subject=Link from Bloglovin"), 'data-func':("emailPost"), 'data-post-id':("" + (post.id) + ""), 'target':("_blank") }, {"href":true,"data-func":true,"data-post-id":true,"target":true})) + "><div class=\"email-icon\"></div><span>" + (jade.escape(null == (jade.interp = t('email', { defaultValue: 'Email' })) ? "" : jade.interp)) + "</span></a></li><li><a" + (jade.attrs({ 'href':("" + (post.post_link) + ""), 'rel':("nofollow"), 'data-func':("facebookPost"), 'data-desc':(post.summary ? "" + (post.summary) + "" : null), 'data-name':("" + (post.title) + ""), 'data-caption':("" + (post.source) + ""), 'data-pic':(post.media ? "" + (post.media) + "" : null), 'data-post-id':("" + (post.id) + "") }, {"href":true,"rel":true,"data-func":true,"data-desc":true,"data-name":true,"data-caption":true,"data-pic":true,"data-post-id":true})) + "><div class=\"facebook-icon\"></div><span>" + (jade.escape(null == (jade.interp = t('facebook', { defaultValue: 'Facebook' })) ? "" : jade.interp)) + "</span></a></li><li><a" + (jade.attrs({ 'href':("https://twitter.com/share?url=" + (encodeURIComponent(post.post_link)) + "&via=bloglovin&text=" + (encodeURIComponent(post.title)) + ""), 'rel':("nofollow"), 'data-func':("tweet"), 'data-post-id':("" + (post.id) + ""), 'data-title':(t('twitter_popup_title', { defaultValue: 'Tweet this!' })), 'target':("_blank") }, {"href":true,"rel":true,"data-func":true,"data-post-id":true,"data-title":true,"target":true})) + "><div class=\"twitter-icon\"></div><span>" + (jade.escape(null == (jade.interp = t('twitter', { defaultValue: 'Twitter' })) ? "" : jade.interp)) + "</span></a></li><li class=\"last-child\"><a" + (jade.attrs({ 'href':("" + (post.post_link) + ""), 'rel':("nofollow"), 'data-func':("pin"), 'data-name':("" + (post.title) + ""), 'data-pic':(post.media ? "" + (post.media) + "" : null), 'data-post-id':("" + (post.id) + "") }, {"href":true,"rel":true,"data-func":true,"data-name":true,"data-pic":true,"data-post-id":true})) + "><div class=\"pinterest-icon\"></div><span>" + (jade.escape(null == (jade.interp = t('pinterest', { defaultValue: 'Pinterest' })) ? "" : jade.interp)) + "</span></a></li></ul></div></div></li>");
}
    }
...
buf.push("<a href=\"#\" class=\"read\">" + (jade.escape(null == (jade.interp = t('post_blog_mark_blog_as_read', { defaultValue: 'Mark blog as read' })) ? "" : jade.interp)) + "</a></div></li>");;return buf.join("");
}
,
"signup/errors/unknown":function anonymous(locals) {
var buf = [];
var locals_ = (locals || {}),errors = locals_.errors,t = locals_.t;if ( errors)
{
buf.push(jade.escape(null == (jade.interp = t('signup_error_unknown', { defaultValue: 'A problem occurred. Please try again!', context: errors.unknown } )) ? "" : jade.interp));
}
else
{
buf.push(jade.escape(null == (jade.interp = t('signup_error_unknown', { defaultValue: 'A problem occurred. Please try again!' } )) ? "" : jade.interp));
};return buf.join("");
}
,
"feed/post":function anonymous(locals) {
var buf = [];
var locals_ = (locals || {}),post = locals_.post,count = locals_.count,default_avatar = locals_.default_avatar,avatar = locals_.avatar,baseUrl = locals_.baseUrl,t = locals_.t,contextType = locals_.contextType,imagesize = locals_.imagesize,url = locals_.url,likeSpan = locals_.likeSpan,likeSpanEnd = locals_.likeSpanEnd;if ( (post.event_type === 'follow_user' || post.event_type === 'follow_blog'))
{
buf.push("<li" + (jade.attrs({ 'data-index':(count), "class": [('post'),('follow-post')] }, {"data-index":true})) + "><article>");
var avatar_mixin = function(user){
var block = this.block, attributes = this.attributes || {}, escaped = this.escaped || {};
...
'for adults. In general, Bloglovin does not review nor do we endorse the',
...
var signedin = (current_user.userid) ? 'yes' : 'no'
buf.push("<!-- Google Analytics--><script>var _gaq = _gaq || [];\nvar _gatags = [];\nvar url = document.location.pathname;\n_gatags.push('bl');\n_gaq.push(['bl._setAccount', '" + (jade.escape((jade.interp = GENERIC_VISIT) == null ? '' : jade.interp)) + "']);\n_gaq.push(['bl._setCustomVar',1,'adview','yes',3]);\n_gaq.push(['bl._setCustomVar',2,'signedin','" + (jade.escape((jade.interp = signedin) == null ? '' : jade.interp)) + "',2]);\n_gaq.push(['bl._setCustomVar',3,'category','0',3]);\n_gaq.push(['bl._trackPageview', url]);\n_gatags.push('bl_local');\n_gaq.push(['bl_local._setAccount', '" + (jade.escape((jade.interp = countryTag) == null ? '' : jade.interp)) + "']);\n_gaq.push(['bl_local._trackPageview',url]);\n_gaq.push(['bl_local._setCustomVar',1,'adview','yes',3]);\n_gaq.push(['bl_local._setCustomVar',2,'signedin','" + (jade.escape((jade.interp = signedin) == null ? '' : jade.interp)) + "',2]);\n_gaq.push(['bl_local._setCustomVar',3,'category','0',3]);\n_gatags.push('bl_page_1');\nvar tags = [];\nswitch ('" + (jade.escape((jade.interp = locals.deviceFamily) == null ? '' : jade.interp)) + "') {\n  case 'mobile':\n    tags.push('" + (jade.escape((jade.interp = MOBILE_ALL) == null ? '' : jade.interp)) + "');\n    tags.push('" + (jade.escape((jade.interp = MOBILE_WEB) == null ? '' : jade.interp)) + "');\n    break;\n  default:\n    tags.push('" + (jade.escape((jade.interp = DEFAULT) == null ? '' : jade.interp)) + "');\n}\nfor (var tag in tags) {\n  _gaq.push(['bl_page_1._setAccount', tags[tag]]);\n  _gaq.push(['bl_page_1._trackPageview', url]);\n  _gaq.push(['bl_page_1._setCustomVar',1,'adview','yes',3]);\n  _gaq.push(['bl_page_1._setCustomVar',2,'signedin','" + (jade.escape((jade.interp = signedin) == null ? '' : jade.interp)) + "',2]);\n  _gaq.push(['bl_page_1._setCustomVar',3,'category','0',3]);\n}\n(function() {\n  var ga    = document.createElement('script');\n  ga.type   = 'text/javascript';\n  ga.async  = true;\n  ga.src    = ('https:' == document.location.protocol ? 'https://ssl' : 'http://www') + '.google-analytics.com/ga.js';\n  var s     = document.getElementsByTagName('script')[0];\n  s.parentNode.insertBefore(ga, s);\n})();\n</script><!-- QuantCast--><script>var _qevents = _qevents || [];\n\n(function() {\n  var elem = document.createElement('script');\n  elem.src = (document.location.protocol == \"https:\" ? \"https://secure\" : \"http://edge\") + \".quantserve.com/quant.js\";\n  elem.async = true;\n  elem.type = \"text/javascript\";\n  var scpt = document.getElementsByTagName('script')[0];\n  scpt.parentNode.insertBefore(elem, scpt);\n})();\n\n_qevents.push({ qacct:\"p-6EEmuZFR-4XGE\" });\n</script><noscript><div style=\"display:none\"><img src=\"//pixel.quantserve.com/pixel/p-6EEmuZFR-4XGE.gif\" border=\"0\" height=\"1\" width=\"1\" alt=\"Quantcast\"></div></noscript><!-- ComScore--><script>var _comscore = _comscore || [];\n_comscore.push({ c1: \"2\", c2: \"6035233\" });\n(function() {\n  var s   = document.createElement(\"script\"), el = document.getElementsByTagName(\"script\")[0];\n  s.async = true;\n  s.src   = (document.location.protocol == \"https:\" ? \"https://sb\" : \"http://b\") + \".scorecardresearch.com/beacon.js\";\n  el.parentNode.insertBefore(s, el);\n})();</script><noscript><img src=\"https://b.scorecardresearch.com/p?c1=2&amp;c2=6035233&amp;cv=2.0&amp;cj=1\"></noscript><!-- DFP tracking ad--><div data-placement=\"tracking\" class=\"ad_placement\"></div></head><body data-page-type=\"get_mobile\"><noscript><div class=\"alert-news\">" + (jade.escape(null == (jade.interp = t('no_js_no_play', { defaultValue : 'It looks like your browser doesn\'t support javascript. This page will work a lot better for you if you activate javascript or download a new browser like'})) ? "" : jade.interp)) + " <a href=\"https://www.google.com/chrome/\" rel=\"nofollow\" target=\"_blank\">Google Chrome</a>.</div></noscript><div id=\"fb-root\"></div><div data-placement=\"panorama\" class=\"ad-placement\"></div>");
...
var block = this.block, attributes = this.attributes || {}, escaped = this.escaped || {};
buf.push("<li><a" + (jade.attrs({ terse: true, 'href':("" + (baseUrl) + "/login") }, {"href":true})) + ">" + (jade.escape(null == (jade.interp = t('nav_login', { defaultValue: 'Log in' })) ? "" : jade.interp)) + "</a></li><li><a" + (jade.attrs({ terse: true, 'href':("" + (baseUrl) + "/signup") }, {"href":true})) + ">" + (jade.escape(null == (jade.interp = t('nav_sign_up', { defaultValue: 'Sign up' })) ? "" : jade.interp)) + "</a></li>");
};
buf.push("<div class=\"header\"><nav><div class=\"logo nav-item\"><a href=\"/\" class=\"home\">Bloglovin&apos;</a></div><a href=\"#main-nav\" data-trigger=\"dropdown\" class=\"hamburger\">Jump to main navigation</a><ul id=\"main-nav\" class=\"main-navigation\">");
...
if ( !current_user.userid)
{
buf.push("<li class=\"drop-down\"><a" + (jade.attrs({ terse: true, 'href':("" + (baseUrl) + "/what-is-bloglovin"), 'data-trigger':("dropdown"), "class": [('about'),("unclickable")] }, {"class":true,"href":true,"data-trigger":true})) + ">" + (jade.escape(null == (jade.interp = t('nav_about', { defaultValue: 'About' })) ? "" : jade.interp)) + "</a><ul id=\"about\" class=\"dropdown-menu\"><li><ul><li><a" + (jade.attrs({ terse: true, 'href':("" + (baseUrl) + "/what-is-bloglovin") }, {"href":true})) + ">" + (jade.escape(null == (jade.interp = t('nav_about_what_is_bloglovin', { defaultValue: 'What is Bloglovin?' })) ? "" : jade.interp)) + "</a></li><li><a href=\"http://help.bloglovin.com\">" + (jade.escape(null == (jade.interp = t('nav_user_help', { defaultValue: 'Help' })) ? "" : jade.interp)) + "</a></li><li><a" + (jade.attrs({ terse: true, 'href':("" + (baseUrl) + "/widgets") }, {"href":true})) + ">" + (jade.escape(null == (jade.interp = t('nav_user_buttons', { defaultValue: 'Bloglovin button' })) ? "" : jade.interp)) + "</a></li></ul></li><li><ul><li><a" + (jade.attrs({ terse: true, 'href':("" + (baseUrl) + "/about") }, {"href":true})) + ">" + (jade.escape(null == (jade.interp = t('nav_user_about', { defaultValue: 'About' })) ? "" : jade.interp)) + "</a></li><li><a" + (jade.attrs({ terse: true, 'href':("" + (baseUrl) + "/jobs") }, {"href":true})) + ">" + (jade.escape(null == (jade.interp = t('nav_about_jobs', { defaultValue: 'Jobs' })) ? "" : jade.interp)) + "</a></li><li><a" + (jade.attrs({ terse: true, 'href':("" + (baseUrl) + "/cookies") }, {"href":true})) + ">" + (jade.escape(null == (jade.interp = t('nav_about_cookies', { defaultValue: 'Cookies' })) ? "" : jade.interp)) + "</a></li><li><a" + (jade.attrs({ terse: true, 'href':("" + (baseUrl) + "/advertising") }, {"href":true})) + ">" + (jade.escape(null == (jade.interp = t('nav_about_advertising', { defaultValue: 'Advertising' })) ? "" : jade.interp)) + "</a></li></ul></li></ul></li>");
}
...
buf.push("<a" + (jade.attrs({ terse: true, 'href':("" + (baseUrl) + "/" + (profile_url) + ""), 'data-trigger':("dropdown") }, {"href":true,"data-trigger":true})) + "><div class=\"avatar\"><img" + (jade.attrs({ terse: true, 'src':(current_user.avatar) }, {"src":true})) + "><div class=\"large-only\"><div class=\"arrow-down-icon icon\"></div></div></div></a><ul class=\"dropdown-menu\"><li><ul><li><a" + (jade.attrs({ terse: true, 'data-subgroup':("profile"), 'href':("" + (baseUrl) + "/" + (profile_url) + "") }, {"data-subgroup":true,"href":true})) + ">" + (jade.escape(null == (jade.interp = t('nav_user_profile', { defaultValue: 'Profile' })) ? "" : jade.interp)) + "</a></li><li><a" + (jade.attrs({ terse: true, 'data-subgroup':("blog_analytics"), 'href':("" + (baseUrl) + "/myblog") }, {"data-subgroup":true,"href":true})) + ">" + (jade.escape(null == (jade.interp = t('nav_user_my_blogs', { defaultValue: 'Your blogs' })) ? "" : jade.interp)) + "</a></li></ul></li><li><ul><li><a" + (jade.attrs({ terse: true, 'data-subgroup':("bloglovin_button"), 'href':("" + (baseUrl) + "/widgets") }, {"data-subgroup":true,"href":true})) + ">" + (jade.escape(null == (jade.interp = t('nav_user_buttons', { defaultValue: 'Bloglovin button' })) ? "" : jade.interp)) + "</a></li><li><a" + (jade.attrs({ terse: true, 'data-subgroup':("find_friends"), 'href':("" + (baseUrl) + "/friends") }, {"data-subgroup":true,"href":true})) + ">" + (jade.escape(null == (jade.interp = t('nav_user_invite_friends', { defaultValue: 'Find friends' })) ? "" : jade.interp)) + "</a></li><li><a" + (jade.attrs({ terse: true, 'data-subgroup':("edit_blogs_followed"), 'href':("" + (baseUrl) + "/subscriptions") }, {"data-subgroup":true,"href":true})) + ">" + (jade.escape(null == (jade.interp = t('nav_user_edit_blogs', { defaultValue: 'Edit blogs you follow' })) ? "" : jade.interp)) + "</a></li><li><a" + (jade.attrs({ terse: true, 'data-subgroup':("settings"), 'href':("" + (baseUrl) + "/settings") }, {"data-subgroup":true,"href":true})) + ">" + (jade.escape(null == (jade.interp = t('nav_user_settings', { defaultValue: 'Settings' })) ? "" : jade.interp)) + "</a></li><li><a data-subgroup=\"help\" href=\"http://help.bloglovin.com\">" + (jade.escape(null == (jade.interp = t('nav_user_help', { defaultValue: 'Help' })) ? "" : jade.interp)) + "</a></li></ul></li><li><ul><li><a" + (jade.attrs({ terse: true, 'data-subgroup':("logout"), 'href':("" + (baseUrl) + "/logout"), "class": [('logout')] }, {"data-subgroup":true,"href":true})) + ">" + (jade.escape(null == (jade.interp = t('nav_user_sign_out', { defaultValue: 'Sign out' })) ? "" : jade.interp)) + "</a></li></ul></li></ul></div></li></ul><ul class=\"notifications nav-item\"><div class=\"medium-and-up\"><li data-trigger=\"popover\" data-po-position=\"bottom\"><div class=\"bell-icon-container\"><div class=\"bell-icon\"></div><div class=\"notification-count\"></div></div></li><div class=\"popover\"><div class=\"arrow\"></div><div class=\"popover-content\"><header>" + (jade.escape(null == (jade.interp = t('notifications_title', { defaultValue: 'Notifications' })) ? "" : jade.interp)) + "</header><ul id=\"notification-list\"></ul><div id=\"no-notifications\">" + (jade.escape(null == (jade.interp = t('no_new_notifications', { defaultValue: 'All caught up!'})) ? "" : jade.interp)) + "</div><footer></footer></div></div></div></ul>");
}
else
{
...
buf.push("</ul></div></div><div class=\"to-top hidden\"><a id=\"toTop\" href=\"#\"><div class=\"to-top-icon icon\"></div></a></div><section class=\"get-mobile\"><div class=\"container\"><div class=\"content\"><h1>" + (jade.escape(null == (jade.interp = t('get_mobile_get_app', { defaultValue: 'Get the app' })) ? "" : jade.interp)) + "</h1><h2>" + (jade.escape(null == (jade.interp = t('get_mobile_available', { defaultValue: 'Available for iPhone, Android and iPad.' })) ? "" : jade.interp)) + "</h2><div><a href=\"https://itunes.apple.com/app/bloglovin/id421818340\" rel=\"nofollow\" data-app-type=\"iphone\" class=\"app-store-icon download-app\"></a><a href=\"https://play.google.com/store/apps/details?id=se.yo.android.bloglovin\" rel=\"nofollow\" data-app-type=\"android\" class=\"download-app\"><img src=\"/assets/gfx/googleplay.png\" alt=\"Google Play Store\" class=\"play-store-icon\"></a></div></div><div class=\"image\"></div><div class=\"cf\"></div></div></section><footer class=\"footer\"><a href=\"https://www.facebook.com/Bloglovin\" rel=\"nofollow\" alt=\"Facebook\">Facebook</a><span>&#8901;</span><a href=\"https://twitter.com/bloglovin\" rel=\"nofollow\" alt=\"Twitter\">Twitter</a><span>&#8901;</span><a href=\"http://blog.bloglovin.com/\" alt=\"Bloglovin Blog\">Blog</a><span>&#8901;</span><a href=\"http://help.bloglovin.com/\" alt=\"Bloglovin Help\">Help</a></footer><script>var BLClientData = " + (((jade.interp = JSON.stringify(clientData)) == null ? '' : jade.interp)) + ";\n</script><script" + (jade.attrs({ terse: true, 'src':("/assets/js/all-" + (jsLastModified) + ".js") }, {"src":true})) + "></script></body></html>");;return buf.join("");
}
,
"partials/visit_feed_popover":function anonymous(locals) {
var buf = [];
var locals_ = (locals || {}),t = locals_.t;buf.push("<div id=\"visitFeedPopover\" class=\"popover onboarding-popover visit-feed-popover bottom\"><div class=\"arrow\"></div><div class=\"popover-content\"><p>" + (jade.escape(null == (jade.interp = t('visit_feed_popover', { defaultValue: 'Awesome! Whenever a blog updates, its posts will show up here!' })) ? "" : jade.interp)) + "</p></div></div>");;return buf.join("");
}
,
"posts/tiled_post":function anonymous(locals) {
var buf = [];
var locals_ = (locals || {}),post = locals_.post,hideContentText = locals_.hideContentText,context = locals_.context,t = locals_.t,blog_flags = locals_.blog_flags,current_user = locals_.current_user;buf.push("<li class=\"post\"><article" + (jade.attrs({ 'data-blog-id':("" + (post.blog.id) + ""), 'data-post-id':("" + (post.id) + ""), 'data-url':("" + (post.link) + ""), 'data-post-name':("" + (post.title) + ""), 'data-post-media':("" + (post.media_new_post) + ""), 'data-blog-name':("" + (post.blog.name) + ""), "class": [([post.liked ? 'liked' : '', post.likes ? 'has-likes' : ''])] }, {"class":true,"data-blog-id":true,"data-post-id":true,"data-url":true,"data-post-name":true,"data-post-media":true,"data-blog-name":true})) + "><a" + (jade.attrs({ 'href':(post.out_link), 'rel':("nofollow"), 'target':("_blank"), "class": [('media-link')] }, {"href":true,"rel":true,"target":true})) + ">");
if ( post.media)
{
buf.push("<img" + (jade.attrs({ 'src':(post.media_new_post), "class": [('media')] }, {"src":true})) + "/>");
}
buf.push("</a><div class=\"post-content\"><a" + (jade.attrs({ 'href':(post.out_link), 'rel':("nofollow"), 'target':("_blank"), "class": [('post-link')] }, {"href":true,"rel":true,"target":true})) + "><h3 class=\"title\">" + (null == (jade.interp = post.title) ? "" : jade.interp) + "</h3></a><div class=\"subtext\"><a" + (jade.attrs({ 'href':("/blog/" + (post.blog.id) + ""), "class": [('author')] }, {"href":true})) + ">" + (null == (jade.interp = post.blog.name) ? "" : jade.interp) + "</a>&nbsp;&middot;&nbsp;<a" + (jade.attrs({ 'href':("" + (post.post_link) + ""), "class": [('timestamp')] }, {"href":true})) + "><time" + (jade.attrs({ 'datetime':(post.publish_timestamp) }, {"datetime":true})) + ">" + (jade.escape(null == (jade.interp = post.publish_date) ? "" : jade.interp)) + "</time></a>");
if ( !hideContentText)
{
buf.push("<a" + (jade.attrs({ 'href':(post.out_link), 'rel':("nofollow"), 'target':("_blank"), "class": [('post-link')] }, {"href":true,"rel":true,"target":true})) + "><div class=\"body\">" + (null == (jade.interp = post.summary) ? "" : jade.interp) + "</div></a>");
}
...
buf.push("</div></article><div" + (jade.attrs({ 'id':("shareModal-" + (post.blog.id) + "-" + (post.id) + ""), "class": [('modal'),('share-modal')] }, {"id":true})) + "><div class=\"modal-header\"><a href=\"#\" class=\"close\">&times;</a><div class=\"modal-label\">" + (jade.escape(null == (jade.interp = t('share_modal_label', { defaultValue: 'Share post'})) ? "" : jade.interp)) + "</div></div><div class=\"modal-body\"><ul><li><a" + (jade.attrs({ 'href':("mailto:?body=" + (encodeURIComponent(post.title)) + " from the blog " + (encodeURIComponent(post.blog.name)) + " %0A" + (encodeURIComponent(post.post_link)) + " %0A%0ASign up for Bloglovin:%0Ahttp://www.bloglovin.com/signup&subject=Link from Bloglovin"), 'data-func':("emailPost"), 'data-post-id':("" + (post.id) + ""), 'target':("_blank") }, {"href":true,"data-func":true,"data-post-id":true,"target":true})) + "><div class=\"email-icon\"></div><span>" + (jade.escape(null == (jade.interp = t('email', { defaultValue: 'Email' })) ? "" : jade.interp)) + "</span></a></li><li><a" + (jade.attrs({ 'href':("" + (post.post_link) + ""), 'rel':("nofollow"), 'data-func':("facebookPost"), 'data-desc':(post.summary ? "" + (post.summary) + "" : null), 'data-name':("" + (post.title) + ""), 'data-caption':("" + (post.source) + ""), 'data-pic':(post.media ? "" + (post.media) + "" : null), 'data-post-id':("" + (post.id) + "") }, {"href":true,"rel":true,"data-func":true,"data-desc":true,"data-name":true,"data-caption":true,"data-pic":true,"data-post-id":true})) + "><div class=\"facebook-icon\"></div><span>" + (jade.escape(null == (jade.interp = t('facebook', { defaultValue: 'Facebook' })) ? "" : jade.interp)) + "</span></a></li><li><a" + (jade.attrs({ 'href':("https://twitter.com/share?url=" + (encodeURIComponent(post.post_link)) + "&via=bloglovin&text=" + (encodeURIComponent(post.title)) + ""), 'rel':("nofollow"), 'data-func':("tweet"), 'data-post-id':("" + (post.id) + ""), 'data-title':(t('twitter_popup_title', { defaultValue: 'Tweet this!' })), 'target':("_blank") }, {"href":true,"rel":true,"data-func":true,"data-post-id":true,"data-title":true,"target":true})) + "><div class=\"twitter-icon\"></div><span>" + (jade.escape(null == (jade.interp = t('twitter', { defaultValue: 'Twitter' })) ? "" : jade.interp)) + "</span></a></li><li class=\"last-child\"><a" + (jade.attrs({ 'href':("" + (post.post_link) + ""), 'rel':("nofollow"), 'data-func':("pin"), 'data-name':("" + (post.title) + ""), 'data-pic':(post.media ? "" + (post.media) + "" : null), 'data-post-id':("" + (post.id) + "") }, {"href":true,"rel":true,"data-func":true,"data-name":true,"data-pic":true,"data-post-id":true})) + "><div class=\"pinterest-icon\"></div><span>" + (jade.escape(null == (jade.interp = t('pinterest', { defaultValue: 'Pinterest' })) ? "" : jade.interp)) + "</span></a></li></ul></div></div></li>");;return buf.join("");
}
,
"signup/errors/password":function anonymous(locals) {
var buf = [];
var locals_ = (locals || {}),errors = locals_.errors,t = locals_.t;if ( errors)
{
buf.push(jade.escape(null == (jade.interp = t('signup_error_password', { defaultValue: 'Password must be at least 6 characters.', context: errors.password } )) ? "" : jade.interp));
}
else
{
buf.push(jade.escape(null == (jade.interp = t('signup_error_password', { defaultValue: 'Password must be at least 6 characters.' } )) ? "" : jade.interp));
};return buf.join("");
}
,
...
var buf = [];
var locals_ = (locals || {}),t = locals_.t;buf.push("<div id=\"findBlogsPopover\" class=\"popover onboarding-popover find-blogs-popover bottom\"><div class=\"arrow\"></div><div class=\"popover-content\"><p>" + (jade.escape(null == (jade.interp = t('find_blogs_popover', { defaultValue: 'Welcome! Click here to find more blogs to follow.' })) ? "" : jade.interp)) + "</p></div></div>");;return buf.join("");
}
,
...
var likesLinkEnd = '</a>';
buf.push(null == (jade.interp = t('gritter_post_liked', { defaultValue: 'was saved to __likesLinkHTML__ your Likes.__likesLinkEndHTML__', escapeInterpolation: true, likesLink: likesLink, likesLinkEnd: likesLinkEnd })) ? "" : jade.interp);;return buf.join("");
}
,
"invite/fb_friends":function anonymous(locals) {
var buf = [];
var locals_ = (locals || {}),friends = locals_.friends;var friendsLen = friends.length;
// iterate friends
;(function(){
  var $$obj = friends;
  if ('number' == typeof $$obj.length) {
    ...
    for (var count = 0, $$l = $$obj.length; count < $$l; count++) {
      var friend = $$obj[count];

buf.push("<div class=\"friend\"><img" + (jade.attrs({ 'src':(friend.picture.data.url) }, {"src":true})) + "/>" + (jade.escape(null == (jade.interp = friend.name) ? "" : jade.interp)) + "<input" + (jade.attrs({ 'type':("checkbox"), 'checked':("true"), 'data-id':(friend.id) }, {"type":true,"checked":true,"data-id":true})) + "/>");
if ( (count != (friendsLen - 1)))
{
buf.push("<div class=\"divider\"></div>");
}
buf.push("</div>");
    }
...
alert_mixin();
buf.push("<a data-trigger=\"hide\" class=\"cancel\">" + (jade.escape(null == (jade.interp = t('flag_blog_modal_cancel', { defaultValue: 'Cancel' })) ? "" : jade.interp)) + "</a><a" + (jade.attrs({ 'href':("http://help.bloglovin.com"), 'data-blog-id':(flag.blog_id), 'data-flag-id':(flag.flag_id), 'data-post-id':(flag.post_id), "class": [('confirm-flag')] }, {"href":true,"data-blog-id":true,"data-flag-id":true,"data-post-id":true})) + ">" + (jade.escape(null == (jade.interp = t('flag_blog_modal_confirm', { defaultValue: 'Report' })) ? "" : jade.interp)) + "</a>");
}
buf.push("</div></div>");;return buf.join("");
}
,
"signup/errors/first_name":function anonymous(locals) {
var buf = [];
var locals_ = (locals || {}),t = locals_.t;buf.push(jade.escape(null == (jade.interp = t('signup_error_name', { defaultValue: 'Please enter your full name.' } )) ? "" : jade.interp));;return buf.join("");
}
,
"sidebar/show_read":function anonymous(locals) {
var buf = [];
var locals_ = (locals || {}),num_read = locals_.num_read,t = locals_.t;buf.push("<li" + (jade.attrs({ "class": [('show-read'),(num_read > 0 ? '' : 'hide')] }, {"class":true})) + "><a href=\"#\">" + (jade.escape(null == (jade.interp = t('show_read_blogs', { defaultValue: 'Show read blogs' })) ? "" : jade.interp)) + "</a></li><li class=\"hide-read\"><a href=\"#\">" + (jade.escape(null == (jade.interp = t('hide_read_blogs', { defaultValue: 'Hide read blogs' })) ? "" : jade.interp)) + "</a></li>");;return buf.join("");
}
,
...
var buf = [];
var locals_ = (locals || {}),pageTitle = locals_.pageTitle,canonical = locals_.canonical,hide_smart_banner = locals_.hide_smart_banner,meta_tags = locals_.meta_tags,cssFilePath = locals_.cssFilePath,extraScripts = locals_.extraScripts,ads = locals_.ads,langData = locals_.langData,no = locals_.no,se = locals_.se,us = locals_.us,current_user = locals_.current_user,showSignupModal = locals_.showSignupModal,t = locals_.t,clientData = locals_.clientData,jsLastModified = locals_.jsLastModified,blog = locals_.blog,hideDescription = locals_.hideDescription,baseUrl = locals_.baseUrl,frameLink = locals_.frameLink,post = locals_.post;buf.push("<!DOCTYPE html><html" + (jade.attrs({ terse: true, 'lang':(locals.currentLanguage || 'en'), "class": [('viewer')] }, {"lang":true})) + "><head><title>" + (jade.escape(null == (jade.interp = pageTitle || 'Bloglovin') ? "" : jade.interp)) + "</title>");
if ( (canonical))
{
buf.push("<link" + (jade.attrs({ terse: true, 'rel':("canonical"), 'href':("" + (canonical) + "") }, {"rel":true,"href":true})) + ">");
}
...
if ( (post))
{
buf.push("<div class=\"share-list\"><a" + (jade.attrs({ terse: true, 'href':("" + (post.post_link) + ""), 'rel':("nofollow"), 'data-func':("pin"), 'data-name':("" + (post.title) + ""), 'data-pic':(post.media ? "" + (post.media) + "" : null), 'data-post-id':("" + (post.id) + "") }, {"href":true,"rel":true,"data-func":true,"data-name":true,"data-pic":true,"data-post-id":true})) + "><div class=\"pinterest-icon-background\"><div class=\"pinterest-icon\"></div></div></a><a" + (jade.attrs({ terse: true, 'href':("" + (post.post_link) + ""), 'rel':("nofollow"), 'data-func':("facebookPost"), 'data-desc':(post.summary ? "" + (post.summary) + "" : null), 'data-name':("" + (post.title) + ""), 'data-caption':("" + (post.source) + ""), 'data-pic':(post.media ? "" + (post.media) + "" : null), 'data-post-id':("" + (post.id) + "") }, {"href":true,"rel":true,"data-func":true,"data-desc":true,"data-name":true,"data-caption":true,"data-pic":true,"data-post-id":true})) + "><div class=\"facebook-icon-background\"><div class=\"facebook-icon\"></div></div></a><a" + (jade.attrs({ terse: true, 'href':("https://twitter.com/share?url=" + (encodeURIComponent(post.post_link)) + "&via=bloglovin&text=" + (encodeURIComponent(post.title)) + ""), 'rel':("nofollow"), 'data-func':("tweet"), 'data-post-id':("" + (post.id) + ""), 'data-title':(t('twitter_popup_title', { defaultValue: 'Tweet this!' })), 'target':("_blank") }, {"href":true,"rel":true,"data-func":true,"data-post-id":true,"data-title":true,"target":true})) + "><div class=\"twitter-icon-background\"><div class=\"twitter-icon\"></div></div></a><a" + (jade.attrs({ terse: true, 'href':("mailto:?body=" + (encodeURIComponent(post.title)) + " from the blog " + (encodeURIComponent(post.blog.name)) + " %0A" + (encodeURIComponent(post.post_link)) + " %0A%0ASign up for Bloglovin:%0Ahttp://www.bloglovin.com/signup&subject=" + (encodeURIComponent(post.title)) + " from Bloglovin"), 'data-func':("emailPost"), 'data-post-id':("" + (post.id) + ""), 'target':("_blank") }, {"href":true,"data-func":true,"data-post-id":true,"target":true})) + "><div class=\"email-icon-background\"><div class=\"email-icon\"></div></div></a></div>");
}
else
{
buf.push("<div class=\"share-list\"><a" + (jade.attrs({ terse: true, 'href':("" + (baseUrl + '/blog/' + blog.id) + ""), 'data-func':("facebookPost"), 'data-desc':(blog.description ? "" + (blog.description) + "" : null), 'data-name':("" + (blog.name) + ""), 'data-caption':("" + (baseUrl + '/blog/' + blog.id) + ""), 'data-pic':(blog.snap ? "" + (blog.snap) + "" : null), 'data-blog-id':("" + (blog.id) + "") }, {"href":true,"data-func":true,"data-desc":true,"data-name":true,"data-caption":true,"data-pic":true,"data-blog-id":true})) + "><div class=\"facebook-icon-background\"><div class=\"facebook-icon\"></div></div></a><a" + (jade.attrs({ terse: true, 'href':("https://twitter.com/share?url=" + (encodeURIComponent(baseUrl + '/blog/' + blog.id)) + "&via=bloglovin&text=" + (encodeURIComponent(blog.name)) + ""), 'rel':("nofollow"), 'data-func':("tweet"), 'data-blog-id':("" + (blog.id) + ""), 'data-title':(t('twitter_popup_title', { defaultValue: 'Tweet this!' })), 'target':("_blank") }, {"href":true,"rel":true,"data-func":true,"data-blog-id":true,"data-title":true,"target":true})) + "><div class=\"twitter-icon-background\"><div class=\"twitter-icon\"></div></div></a><a" + (jade.attrs({ terse: true, 'href':("mailto:?body=" + (encodeURIComponent(blog.name)) + " on Bloglovin %0A" + (encodeURIComponent(baseUrl + '/blog/' + blog.id)) + " %0A%0ASign up for Bloglovin:%0Ahttp://www.bloglovin.com/signup&subject=" + (encodeURIComponent(blog.name)) + " from Bloglovin"), 'data-func':("emailPost"), 'data-blog-id':("" + (blog.id) + ""), 'target':("_blank") }, {"href":true,"data-func":true,"data-blog-id":true,"target":true})) + "><div class=\"email-icon-background\"><div class=\"email-icon\"></div></div></a></div>");
}
buf.push("</div></div><div class=\"bl-viewer-container\"><iframe" + (jade.attrs({ terse: true, 'frameborder':("0"), 'src':("" + (frameLink) + ""), "class": [('bl-viewer')] }, {"frameborder":true,"src":true})) + "></iframe></div></body></html>");;return buf.join("");
}
,
"find_blogs/title":function anonymous(locals) {
var buf = [];
var locals_ = (locals || {}),context = locals_.context,t = locals_.t;if ( context.type === 'recommended')
{
...
var buf = [];
var locals_ = (locals || {}),t = locals_.t;buf.push("<div id=\"getAppModal\" class=\"modal get-app-modal\"><div class=\"modal-body\"><div class=\"not-sent\"><img src=\"/assets/gfx/get-app@2x.png\"/><h4>" + (jade.escape(null == (jade.interp = t("onboarding_get_app_modal_title", { defaultValue: "Enter your phone number to get the Bloglovin app." })) ? "" : jade.interp)) + "</h4><form id=\"getApp\"><fieldset><label>" + (jade.escape(null == (jade.interp = t("onboarding_modal_label", { defaultValue: "Get app" })) ? "" : jade.interp)) + "</label><input" + (jade.attrs({ 'type':("text"), 'value':(""), 'autofocus':("autofocus"), 'placeholder':(t("onboarding_send_text_placeholder", { defaultValue: "+16464801873"})), "class": [('phone-number')] }, {"type":true,"value":true,"autofocus":true,"placeholder":true})) + "/></fieldset><input" + (jade.attrs({ 'type':("submit"), 'value':(t("onboarding_send_button", { defaultValue: "Send" })), "class": [('send-text')] }, {"type":true,"value":true})) + "/></form><p class=\"disclaimer\">" + (jade.escape(null == (jade.interp = t("onboarding_modal_disclaimer", { defaultValue: "We will not store your phone number." })) ? "" : jade.interp)) + "</p><p class=\"send-text-error\">" + (jade.escape(null == (jade.interp = t("onboarding_modal_send_text_error", { defaultValue: "Please enter a valid number with country code!" })) ? "" : jade.interp)) + "</p><a href=\"#\" data-trigger=\"hide\" class=\"dismiss\">" + (jade.escape(null == (jade.interp = t("onboarding_modal_dismiss", { defaultValue: "Maybe later" })) ? "" : jade.interp)) + "</a></div><div class=\"sent\"><p>" + (jade.escape(null == (jade.interp = t("onboarding_modal_text_sent_alert", { defaultValue: "Text sent!" })) ? "" : jade.interp)) + "</p></div></div></div>");;return buf.join("");
}
,
"partials/visit_blog_profile_popover":function anonymous(locals) {
var buf = [];
var locals_ = (locals || {}),t = locals_.t;buf.push("<div id=\"visitBlogProfilePopover\" class=\"popover onboarding-popover visit-blog-profile-popover bottom\"><div class=\"arrow\"></div><div class=\"popover-content\"><p>" + (jade.escape(null == (jade.interp = t('visit_blog_profile_popover', { defaultValue: 'Click here to learn more about this blog.' })) ? "" : jade.interp)) + "</p></div></div>");;return buf.join("");
}
,
"partials/tooltip":function anonymous(locals) {
var buf = [];
var locals_ = (locals || {}),body = locals_.body;buf.push("<div class=\"tooltip top\"><div class=\"tooltip-arrow\"></div><div class=\"tooltip-inner\">" + (jade.escape(null == (jade.interp = body) ? "" : jade.interp)) + "</div></div>");;return buf.join("");
}
,
"feed/feed":function anonymous(locals) {
var buf = [];
var locals_ = (locals || {}),pageTitle = locals_.pageTitle,canonical = locals_.canonical,hide_smart_banner = locals_.hide_smart_banner,meta_tags = locals_.meta_tags,cssFilePath = locals_.cssFilePath,extraScripts = locals_.extraScripts,ads = locals_.ads,langData = locals_.langData,no = locals_.no,se = locals_.se,us = locals_.us,current_user = locals_.current_user,t = locals_.t,categories = locals_.categories,countries = locals_.countries,onboardingCategories = locals_.onboardingCategories,feed = locals_.feed,imagesize = locals_.imagesize,groups = locals_.groups,format = locals_.format,sidebar = locals_.sidebar,default_avatar = locals_.default_avatar,avatar = locals_.avatar,url = locals_.url,likeSpan = locals_.likeSpan,likeSpanEnd = locals_.likeSpanEnd,clientData = locals_.clientData,jsLastModified = locals_.jsLastModified;buf.push("<!DOCTYPE html><html" + (jade.attrs({ terse: true, 'lang':(locals.currentLanguage || 'en') }, {"lang":true})) + "><head><title>" + (jade.escape(null == (jade.interp = pageTitle || 'Bloglovin') ? "" : jade.interp)) + "</title>");
if ( (canonical))
{
buf.push("<link" + (jade.attrs({ terse: true, 'rel':("canonical"), 'href':("" + (canonical) + "") }, {"rel":true,"href":true})) + ">");
}
...
buf.push("<a" + (jade.attrs({ terse: true, 'href':("" + (post.out_link) + ""), 'rel':("nofollow"), 'target':("_blank"), "class": [('post-link'),(readable ? 'readable' : '')] }, {"class":true,"href":true,"rel":true,"target":true})) + ">");
if ( post.media)
{
buf.push("<div class=\"media-container\">");
if ( post.friends || imagesize === 'small')
...
buf.push("<h2 class=\"title\">" + (null == (jade.interp = post.title) ? "" : jade.interp) + "</h2></a><div class=\"subtitle\"><address class=\"author\"><a" + (jade.attrs({ terse: true, 'href':("" + (baseUrl) + "/blog/" + (post.blog.id) + ""), 'rel':("author") }, {"href":true,"rel":true})) + ">" + (null == (jade.interp = post.blog.name) ? "" : jade.interp) + "</a></address>&nbsp;&middot;&nbsp;<div class=\"date\"><a" + (jade.attrs({ terse: true, 'href':("" + (post.post_link) + "") }, {"href":true})) + "><time" + (jade.attrs({ terse: true, 'datetime':(post.publish_timestamp) }, {"datetime":true})) + ">" + (jade.escape(null == (jade.interp = post.publish_date) ? "" : jade.interp)) + "</time></a></div></div><a" + (jade.attrs({ terse: true, 'href':("" + (post.out_link) + ""), 'rel':("nofollow"), 'target':("_blank"), "class": [('post-link'),(readable ? 'readable' : '')] }, {"class":true,"href":true,"rel":true,"target":true})) + "><p class=\"body\">" + (null == (jade.interp = post.summary) ? "" : jade.interp) + "</p></a><ul class=\"meta horizontal-list\">");
if ( (readable))
{
...
buf.push("</li></ul></article></div><ul" + (jade.attrs({ terse: true, 'data-post-id':("" + (post.id) + ""), "class": [('share-dialog')] }, {"data-post-id":true})) + "><li><a" + (jade.attrs({ terse: true, 'href':("" + (post.post_link) + ""), 'rel':("nofollow"), 'data-func':("facebookPost"), 'data-desc':(post.summary ? "" + (post.summary) + "" : null), 'data-name':("" + (post.title) + ""), 'data-caption':("" + (post.source) + ""), 'data-pic':(post.media ? "" + (post.media) + "" : null), "class": [('facebook')] }, {"href":true,"rel":true,"data-func":true,"data-desc":true,"data-name":true,"data-caption":true,"data-pic":true})) + "><div class=\"facebook-button-icon\"></div><span>" + (jade.escape(null == (jade.interp = t('share_dialog_facebook', { defaultValue: 'Post to facebook' })) ? "" : jade.interp)) + "</span></a></li><li><a" + (jade.attrs({ terse: true, 'href':("https://twitter.com/share?url=" + (encodeURIComponent(post.post_link)) + "&via=bloglovin&text=" + (post.title) + ""), 'rel':("nofollow"), 'data-func':("tweet"), 'data-title':(t('twitter_popup_title', { defaultValue: 'Tweet this!' })), 'target':("_blank"), "class": [('twitter')] }, {"href":true,"rel":true,"data-func":true,"data-title":true,"target":true})) + "><div class=\"twitter-button-icon\"></div><span>" + (jade.escape(null == (jade.interp = t('share_dialog_twitter', { defaultValue: 'Tweet this' })) ? "" : jade.interp)) + "</span></a></li></ul><div" + (jade.attrs({ terse: true, 'id':("shareModal-" + (post.blog.id) + "-" + (post.id) + ""), "class": [('modal'),('share-modal')] }, {"id":true})) + "><div class=\"modal-header\"><a href=\"#\" class=\"close\">&times;</a><div class=\"modal-label\">" + (jade.escape(null == (jade.interp = t('share_modal_label', { defaultValue: 'Share post'})) ? "" : jade.interp)) + "</div></div><div class=\"modal-body\"><ul><li><a" + (jade.attrs({ terse: true, 'href':("mailto:?body=" + (encodeURIComponent(post.title)) + " from the blog " + (encodeURIComponent(post.blog.name)) + " %0A" + (encodeURIComponent(post.post_link)) + " %0A%0ASign up for Bloglovin:%0Ahttp://www.bloglovin.com/signup&subject=Link from Bloglovin"), 'data-func':("emailPost"), 'data-post-id':("" + (post.id) + ""), 'target':("_blank") }, {"href":true,"data-func":true,"data-post-id":true,"target":true})) + "><div class=\"email-icon\"></div><span>" + (jade.escape(null == (jade.interp = t('email', { defaultValue: 'Email' })) ? "" : jade.interp)) + "</span></a></li><li><a" + (jade.attrs({ terse: true, 'href':("" + (post.post_link) + ""), 'rel':("nofollow"), 'data-func':("facebookPost"), 'data-desc':(post.summary ? "" + (post.summary) + "" : null), 'data-name':("" + (post.title) + ""), 'data-caption':("" + (post.source) + ""), 'data-pic':(post.media ? "" + (post.media) + "" : null), 'data-post-id':("" + (post.id) + "") }, {"href":true,"rel":true,"data-func":true,"data-desc":true,"data-name":true,"data-caption":true,"data-pic":true,"data-post-id":true})) + "><div class=\"facebook-icon\"></div><span>" + (jade.escape(null == (jade.interp = t('facebook', { defaultValue: 'Facebook' })) ? "" : jade.interp)) + "</span></a></li><li><a" + (jade.attrs({ terse: true, 'href':("https://twitter.com/share?url=" + (encodeURIComponent(post.post_link)) + "&via=bloglovin&text=" + (encodeURIComponent(post.title)) + ""), 'rel':("nofollow"), 'data-func':("tweet"), 'data-post-id':("" + (post.id) + ""), 'data-title':(t('twitter_popup_title', { defaultValue: 'Tweet this!' })), 'target':("_blank") }, {"href":true,"rel":true,"data-func":true,"data-post-id":true,"data-title":true,"target":true})) + "><div class=\"twitter-icon\"></div><span>" + (jade.escape(null == (jade.interp = t('twitter', { defaultValue: 'Twitter' })) ? "" : jade.interp)) + "</span></a></li><li class=\"last-child\"><a" + (jade.attrs({ terse: true, 'href':("" + (post.post_link) + ""), 'rel':("nofollow"), 'data-func':("pin"), 'data-name':("" + (post.title) + ""), 'data-pic':(post.media ? "" + (post.media) + "" : null), 'data-post-id':("" + (post.id) + "") }, {"href":true,"rel":true,"data-func":true,"data-name":true,"data-pic":true,"data-post-id":true})) + "><div class=\"pinterest-icon\"></div><span>" + (jade.escape(null == (jade.interp = t('pinterest', { defaultValue: 'Pinterest' })) ? "" : jade.interp)) + "</span></a></li></ul></div></div></li>");
}
if ( count == 2)
{
...
var feedLinkEnd = '</a>';
buf.push(null == (jade.interp = t('gritter_blog_followed', { defaultValue: 'was added to __feedLinkHTML__ your Feed. __feedLinkEndHTML__', escapeInterpolation: true, feedLink: feedLink, feedLinkEnd: feedLinkEnd })) ? "" : jade.interp);;return buf.join("");
}
,
...
buf.push("</ul></div></div></div></div>");;return buf.join("");
}
,
...
,
"signup/errors/username":function anonymous(locals) {
var buf = [];
var locals_ = (locals || {}),errors = locals_.errors,t = locals_.t;if ( errors)
{
buf.push(jade.escape(null == (jade.interp = t('signup_error_username', { defaultValue: 'Please enter a new username.', context: errors.username } )) ? "" : jade.interp));
}
else
{
buf.push(jade.escape(null == (jade.interp = t('signup_error_username', { defaultValue: 'Please enter a new username.' } )) ? "" : jade.interp));
};return buf.join("");
}
}
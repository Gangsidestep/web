...
<div class="site-header-outer" style="height:60px;background-color: white;width:100%;max-width:1000px; color: #fff!important;
    ...
    <div style="position:absolute; right:14px; top:16px; display:flex; align-items:center; gap:6px;">
      ...
      <select id="language-switcher" onchange="if(this.value){window.location.href=this.value;}" style="border:1px solid #c8ced4; border-radius:4px; background:#fff; color:#2a5d84; font-size:13px; font-weight:700; padding:4px 8px;">

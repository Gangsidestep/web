...
<div class='tile-profile'>
		...
		<input id="user" name="user_id" value="<?php echo $mem_id; ?>" type="hidden">
		<input id="lang" name="lang" value="<?php echo $lang; ?>" type="hidden">
				...
				if(isset($_POST['edit']))
					{
						...
						<div  id='profile_image' class='large_profile_img profile-images' style="background-image: url(<?php echo $image; ?>);"><br><br><br>
     ...
     <img class="new_img" id="new-image" src="">
       <div id="fileList"></div>	
    </form>
